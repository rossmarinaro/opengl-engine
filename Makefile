...
OBJS = vendors/glad/src/glad.c src/main.cpp src/window.cpp src/entities/sprite.cpp src/entities/player.cpp src/entities/map.cpp src/game.cpp #vendors/imgui/imgui.cpp vendors/imgui/imgui_demo.cpp vendors/imgui/imgui_widgets.cpp vendors/imgui/imgui_tables.cpp vendors/imgui/imgui_draw.cpp vendors/imgui/imgui_impl_glfw.cpp vendors/imgui/imgui_impl_opengl3.cpp #src/audio.cpp
